# Type: dbndns::cache_server_factory
#
# A factory class that pulls data from the dbndns::cache_server_entries key in
# hiera, and  uses it to create a set of dbndns::cache_server resources.
#
# Parameters:
#  hiera_key - the key that the hiera look up will use to find your
#    cache_server settings. Defaults to dbndns::cache_server_entries
#  resource_type - the resource to instansiate based on that data. Defaults
#    to dbndns::cache_server
...
#
class dbndns::cache_server_factory
(
  $hiera_key = 'dbndns::cache_server_entries',
  $resource_type = 'dbndns::cache_server',
